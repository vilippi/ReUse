...
export default function Carrinho() {
    ...
    const totals = useMemo(() => {
        ...
        const desconto = subtotal > 100 ? 10 : 0; // mock: R$10 de desconto acima de 100
    ...
    const checkout = () => {
        if (empty) return;
        Alert.alert("Pedido", "Ir para checkout (mock).");
    };
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#f3f4f6" }} edges={["top", "left", "right"]}>
            ...
            {empty ? (
                <View style={styles.empty}>
                    ...
                    <Pressable style={styles.cta} onPress={() => Alert.alert("Explorar", "Ir para Home (mock).")}>
                ...
                <>
                    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 20 }}>
                        ...
                        <View style={styles.summaryCard}>
                            ...
                            <PriceRow label="Frete" value={totals.frete === 0 ? "Grátis" : currency(totals.frete)} />
                            {totals.desconto > 0 && (
